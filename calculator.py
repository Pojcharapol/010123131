...
button_quit = button(10, 150, 80, 60, red, "Off")
    ...
    while state :
        ...
        for e in pygame.event.get():
            ...
            if e.type == pygame.KEYDOWN: #Input from keyboard
                ...
                pygame.draw.rect(window, yellow,(10,30,330, 90))
            ...
            if e.type == pygame.MOUSEBUTTONDOWN:
                ...
                if button_quit.final_pos().collidepoint(mouse_pos):
                    state = False
